...
const updatePayedStatus = async (req, res) => {
    ...
    const order = await OrderService_1.default.updateOrder(id, { payed });
    if (!order)
        return helpers_1.SendError.BAD_REQUEST(res, 'Помилка оновлення');
    return helpers_1.SendResponse.OK(res, 'Статус оновлено', { order: await order.getPublicInfo() });
};
exports.default = {
    ...
    handler: (0, middlewares_1.controllerWrapper)(updatePayedStatus),
};
//# sourceMappingURL=updatePayedStatus.js.map