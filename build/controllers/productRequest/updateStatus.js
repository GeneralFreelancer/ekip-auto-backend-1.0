...
const updateStatus = async (req, res) => {
    ...
    const productRequest = await ProductRequestService_1.default.updateStatus(productRequestId, status);
    if (!productRequest)
        return helpers_1.SendError.BAD_REQUEST(res, 'Запит не знайдено');
    return helpers_1.SendResponse.OK(res, 'Статус оновлено', { productRequest });
};
exports.default = {
    ...
    handler: (0, middlewares_1.controllerWrapper)(updateStatus),
};
