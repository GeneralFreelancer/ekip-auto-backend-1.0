...
const delImage = async (req, res) => {
    ...
    const advertising = await AdvertisingService_1.default.delImage(image);
    if (!advertising)
        return helpers_1.SendError.BAD_REQUEST(res, 'Зображення не знайдено');
    return helpers_1.SendResponse.OK(res, 'Зображення видалено', { advertising: advertising.getPublicInfo() });
};
exports.default = {
