...
const createOrUpdateBasket = async (req, res) => {
    const user = req.user;
    if (!user)
        return helpers_1.SendError.UNAUTHORIZED(res, 'Користувача не знайдено');
    const { products } = req.body;
    const basket = await BasketService_1.default.createOrUpdateBasket(user._id, products);
...
exports.default = {
    ...
    handler: (0, middlewares_1.controllerWrapper)(createOrUpdateBasket),
};
//# sourceMappingURL=createOrUpdateBasket.js.map